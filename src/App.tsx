...
import { getSystemTheme, useTheme } from "./providers/theme-provider";
            ...
            <div className="flex items-center gap-2">
              <Tooltip>
                <TooltipTrigger asChild>
                  <label className="flex cursor-pointer items-center gap-2 text-sm">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setEmailSafeMode(!!checked)}
                    />
                ...
                <TooltipContent align="end">
                  Removes CSS properties unsupported by email clients. Check out{" "}
                  <a
                    rel="noopener noreferrer"
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button size="icon" onClick={reloadPreview} variant="outline">
